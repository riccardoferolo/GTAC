...
export const COMPARSE = Object.freeze([
  ...
  { id: 'dunde', nome: 'Dunde', sprite: SPRITE_CALVO, colori: { R: '#2a1c14', B: '#c83a6a', N: '#2a3a5a' } },
  ...
  { id: 'bolo', nome: 'Il Bolo', sprite: SPRITE_PESCATORE, colori: { H: '#b8a86a', G: '#2a2a30', B: '#eab888', T: '#2a5a7a', N: '#4a4a3a' } },
  { id: 'tipa0', nome: 'Ragazza', sprite: SPRITE_CAPELLI_LUNGHI, colori: { R: '#3a2414', B: '#e03a6a', N: '#2a2a40' } },
  { id: 'tipa1', nome: 'Ragazza', sprite: SPRITE_CAPELLI_LUNGHI, colori: { R: '#e8c060', B: '#8a3ae0', N: '#1e1e30' } },
  { id: 'tipa2', nome: 'Ragazza', sprite: SPRITE_CAPELLI_LUNGHI, colori: { R: '#1a1414', B: '#e0c030', N: '#3a2a4a' } },
  { id: 'tipa3', nome: 'Ragazza', sprite: SPRITE_CAPELLI_LUNGHI, colori: { R: '#8a4a26', B: '#2ab8a8', N: '#20203a' } },
  { id: 'tipa4', nome: 'Ragazza', sprite: SPRITE_CAPELLI_LUNGHI, colori: { R: '#f0d890', B: '#f06040', N: '#2a3050' } },
  { id: 'tipa5', nome: 'Ragazza', sprite: SPRITE_CAPELLI_LUNGHI, colori: { R: '#5a3a22', B: '#ffffff', N: '#1a1a2a' } },
  { id: 'tipa6', nome: 'Ragazza', sprite: SPRITE_CAPELLI_LUNGHI, colori: { R: '#c84a2a', B: '#2a2a30', N: '#3a1a2a' } },
  { id: 'tipa7', nome: 'Ragazza', sprite: SPRITE_CAPELLI_LUNGHI, colori: { R: '#1a1414', B: '#c83a3a', N: '#1a1a1a' } },
  ...
  { id: 'signora-letto', nome: 'Adalgisa', sprite: SPRITE_NONNA, colori: { R: '#c8c8c8', B: '#9ac8e8', W: '#ffffff', N: '#9ac8e8', S: '#f0c8b0' } },
  { id: 'signora-bastone', nome: 'Carmela', sprite: SPRITE_NONNA_OCCHIALI, colori: { R: '#a8a8b0', B: '#2a3a6a', W: '#e8e8f0', N: '#1a1a2a', O: '#8a6a3a', C: '#6a4a2a', S: '#e0b090' } },
