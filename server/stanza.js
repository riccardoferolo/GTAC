...
export const LUOGHI = Object.freeze(['fuori', 'dentro', 'bocce', 'sarpom', 'edicola', 'trasferta', 'chiesa', 'vetri', 'viale', 'biblioteca', 'kebab', 'segreti', 'bellotti', 'arco', 'tasso', 'cena', 'ferragosto', 'casetta', 'hotel', 'parrucchiere']);
